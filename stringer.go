...
func main() {
	...
	for _, typeName := range types {
		g.generate(typeName, *json, *yaml, *sql, *graphqlgo, *text, *transformMethod, *trimPrefix, *lineComment)
	}
...
func (g *Generator) generate(typeName string, includeJSON, includeYAML, includeSQL, includeGraphQLGo, includeText bool, transformMethod string, trimPrefix string, lineComment bool) {
